...
class AccountMoveInherit(models.Model):
    ...
    invoice_outstanding_credits_debits_widget = fields.Binary(
        groups="account.group_account_invoice,account.group_account_readonly,kyz.group_department_only",
    ...
    def _post(self, soft=True):
        print(">>> Custom _post triggered!")
        print(">>> Is superuser:", self.env.su)
        print(">>> Has account.group_account_invoice:", self.env.user.has_group('account.group_account_invoice'))
        print(">>> Has kyz group:", self.env.user.has_group('kyz.group_department_only'))

        if not self.env.su and not (
                self.env.user.has_group('account.group_account_invoice')
                or self.env.user.has_group('kyz.group_department_only')
        ):
